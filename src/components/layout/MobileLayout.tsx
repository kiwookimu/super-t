...
const ResponsiveLayout: React.FC<LayoutProps> = ({ children, activeTab = 'home', onTabChange }) => {
    return (
        <div className="min-h-screen bg-[#f2f4f6] text-gray-900 font-sans">
            ...
            {/* Main Content Area */}
            <main className="min-h-screen pb-24 md:pb-0 md:pt-16 transition-all duration-300 flex flex-col">
            ...
            <nav className="md:hidden fixed bottom-0 left-0 right-0 bg-white border-t border-gray-100 pb-5 pt-3 px-4 rounded-t-3xl shadow-[0_-5px_20px_rgba(0,0,0,0.03)] z-50">
